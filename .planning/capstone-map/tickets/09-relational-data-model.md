...
- **Tables**:
  ...
  - `posts(id pk, slug unique, title, body, expected_subject, expected_category, classify_confidence, classified_at null)` — classification cache columns nullable until the post-classify job runs.
